...
class MockingTests: XCTestCase {
    ...
    func testInputEqualityTests() throws {
        // Strings
        XCTAssertNoThrow(try WebServiceMock.validate(expected: "string", actual: "string", for: Empty()))
        XCTAssertThrowsError(try WebServiceMock.validate(expected: "string1", actual: "string2", for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
        ...
        // Data
        XCTAssertNoThrow(try WebServiceMock.validate(expected: "string".data(using: .utf8)!, actual: "string".data(using: .utf8)!, for: Empty()))
        XCTAssertThrowsError(try WebServiceMock.validate(expected: "string1".data(using: .utf8)!, actual: "string2".data(using: .utf8)!, for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
        ...
        // Number in JSON
        XCTAssertNoThrow(try WebServiceMock.validate(expected: [1], actual: [1], for: Empty()))
        XCTAssertThrowsError(try WebServiceMock.validate(expected: [1,2], actual: [1,9], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
            Got ‘[1, 9]’ but expected ‘[1, 2]’. A difference was found at the path ‘1‘.
            """
        )})
        XCTAssertThrowsError(try WebServiceMock.validate(expected: [1.1,2.2], actual: [1.1,9.9], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
        ...
        // Null in JSON
        XCTAssertNoThrow(try WebServiceMock.validate(expected: ["one",nil], actual: ["one",nil], for: Empty()))
        XCTAssertThrowsError(try WebServiceMock.validate(expected: ["one",nil], actual: ["one","two"], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
        ...
        // Dictionary
        XCTAssertNoThrow(try WebServiceMock.validate(expected: ["one": 1], actual: ["one": 1], for: Empty()))
        XCTAssertThrowsError(try WebServiceMock.validate(expected: ["one": 1], actual: ["one": 9], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
            Got ‘["one": 9]’ but expected ‘["one": 1]’. A difference was found at the path ‘one‘.
            """
        )})
        XCTAssertThrowsError(try WebServiceMock.validate(expected: ["one": 1], actual: ["two": 1], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
        ...
        // Array
        XCTAssertNoThrow(try WebServiceMock.validate(expected: ["one","two"], actual: ["one","two"], for: Empty()))
        XCTAssertThrowsError(try WebServiceMock.validate(expected: ["one","two"], actual: ["one","two","three"], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
            Got ‘["one", "two", "three"]’ but expected ‘["one", "two"]’. A difference was found at the root.
            """
        )})
        XCTAssertThrowsError(try WebServiceMock.validate(expected: ["one","two"], actual: ["one","other"], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
            Got ‘["one", "other"]’ but expected ‘["one", "two"]’. A difference was found at the path ‘1‘.
            """
        )})
        XCTAssertThrowsError(try WebServiceMock.validate(expected: ["array": ["one","two"]], actual: ["array": ["one","other"]], for: Empty()), "", { XCTAssertEqual(($0 as! DecreeError).debugDescription, """
            Error Emptying: A request was made to ‘Empty’ with unexpected input.
